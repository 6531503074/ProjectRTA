                ...
                <div class="courses-grid">
                    <?php while ($course = $enrolled_courses->fetch_assoc()): ?>
                        <div class="course-card">
                            ...
                            <a href="course_detail.php?id=<?php echo $course['id']; ?>" class="view-btn">View Course</a>
                        </div>
                    <?php endwhile; ?>
                </div>
            <?php else: ?>
                ...
                <?php if ($upcoming_assignments->num_rows > 0): ?>
                    ...
                    ?>
                        <div class="assignment-item <?php echo $is_urgent ? 'urgent' : ''; ?>">
                            ...
                            <div class="due-date">Due: <?php echo date('M d, Y', strtotime($assignment['due_date'])); ?></div>
                        </div>
                    <?php endwhile; ?>
                <?php else: ?>
                    <div class="empty-state">
                ...
                <?php if ($recent_announcements->num_rows > 0): ?>
                    <?php while ($announcement = $recent_announcements->fetch_assoc()): ?>
                        <div class="announcement-item">
                            ...
                            <div class="time"><?php echo date('M d, Y', strtotime($announcement['created_at'])); ?></div>
                        </div>
                    <?php endwhile; ?>
                <?php else: ?>
                    <div class="empty-state">
